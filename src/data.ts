...
const PLAYED_GAMES_2024 = {
  ARI: [false, true, false, false, true, false],
  ATL: [false, true, false, true, true, true],
  BAL: [false, false, true, true, true, true],
  BUF: [true, true, true, false, false, true],
  CAR: [false, false, true, false, false, false],
  CHI: [true, false, false, true, true, true],
  ...
  IND: [false, false, true, true, false, true],
  JAX: [false, false, false, false, true, false],
  KC: [true, true, true, true, true, null],
  LAC: [true, true, false, false, null, true],
  LAR: [false, false, true, false, false, null],
  LV: [false, true, false, true, false, false],
  MIA: [true, false, false, false, true, null],
  MIN: [true, true, true, true, true, null],
  NE: [true, false, false, false, false, false],
  NO: [true, true, false, false, false, false, false],
  NYG: [false, false, true, false, true, false],
  NYJ: [false, true, true, false, false, false],
  PHI: [true, false, true, false, null, true],
  PIT: [true, true, true, false, false, true],
  SF: [true, false, false, true, false, true],
  SEA: [true, true, true, false, false, false],
  TB: [true, true, false, true, false, true],
  TEN: [false, false, false, true, null, false],
  WSH: [false, true, true, true, true, false],
};
