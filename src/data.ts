...
const PLAYED_GAMES_2024 = {
  ARI: [false, true, false, false, true, false, true],
  ATL: [false, true, false, true, true, true, false],
  BAL: [false, false, true, true, true, true, true],
  BUF: [true, true, true, false, false, true, true],
  CAR: [false, false, true, false, false, false, false],
  CHI: [true, false, false, true, true, true, null],
  CIN: [false, false, false, true, false, true, true],
  CLE: [false, true, false, false, false, false, false],
  DAL: [true, false, false, true, true, false, null],
  DEN: [false, false, true, true, true, false, true],
  DET: [true, false, true, true, null, true, true],
  GB: [false, true, true, false, true, true, true],
  HOU: [true, true, false, true, true, true, false],
  IND: [false, false, true, true, false, true, true],
  JAX: [false, false, false, false, true, false, true],
  KC: [true, true, true, true, true, null, true],
  LAC: [true, true, false, false, null, true, false],
  LAR: [false, false, true, false, false, null, true],
  LV: [false, true, false, true, false, false, false],
  MIA: [true, false, false, false, true, null, false],
  MIN: [true, true, true, true, true, null, false],
  NE: [true, false, false, false, false, false, false],
  NO: [true, true, false, false, false, false, false],
  NYG: [false, false, true, false, true, false, false],
  NYJ: [false, true, true, false, false, false, false],
  PHI: [true, false, true, false, null, true, true],
  PIT: [true, true, true, false, false, true, true],
  SF: [true, false, false, true, false, true, false],
  SEA: [true, true, true, false, false, false, true],
  TB: [true, true, false, true, false, true, false],
  TEN: [false, false, false, true, null, false, false],
  WSH: [false, true, true, true, true, false, true],
};
