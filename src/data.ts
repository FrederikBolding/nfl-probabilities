...
const PLAYED_GAMES_2024 = {
  ARI: [false, true, false, false, true],
  ATL: [false, true, false, true, true],
  BAL: [false, false, true, true, true],
  BUF: [true, true, true, false, false],
  CAR: [false, false, true, false, false],
  CHI: [true, false, false, true, true],
  CIN: [false, false, false, true, false],
  CLE: [false, true, false, false, false],
  DAL: [true, false, false, true, true],
  DEN: [false, false, true, true, true],
  DET: [true, false, true, true, null],
  GB: [false, true, true, false, true],
  HOU: [true, true, false, true, true],
  IND: [false, false, true, true, false],
  JAX: [false, false, false, false, true],
  KC: [true, true, true, true],
  LAC: [true, true, false, false, null],
  LAR: [false, false, true, false, false],
  LV: [false, true, false, true, false],
  MIA: [true, false, false, false, true],
  MIN: [true, true, true, true, true],
  NE: [true, false, false, false, false],
  NO: [true, true, false, false],
  NYG: [false, false, true, false, true],
  NYJ: [false, true, true, false, false],
  PHI: [true, false, true, false, null],
  PIT: [true, true, true, false, false],
  SF: [true, false, false, true, false],
  SEA: [true, true, true, false, false],
  TB: [true, true, false, true, false],
  TEN: [false, false, false, true, null],
  WSH: [false, true, true, true, true],
};
